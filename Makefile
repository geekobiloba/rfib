...
run: rfib_codon rfib_c rfib_d rfib_crystal rfib_go rfib.jl rfib-chez.scm rfib_gerbil rfib.rkt rfib.luajit rfib.pypy rfib_gambit rfib_sbcl rfib_chicken rfib.rb rfib.py
	@ echo
